...
!(function (e) {
      ...
      (e.validateConfigurationOptions = function (e) {
        ...
        return (
          ...
          ("object" == typeof e.ignoreDuplicateModules &&
            l.isArray(e.ignoreDuplicateModules)) ||
            (e.ignoreDuplicateModules = []),
          e.baseUrl.length > 0 &&
            (l.endsWith(e.baseUrl, "/") || (e.baseUrl += "/")),
          e
        );
      }),
      (e.mergeConfigurationOptions = function (t, n) {
        void 0 === t && (t = null), void 0 === n && (n = null);
        var o = l.recursiveClone(n || {});
        return (
          l.forEachProperty(t, function (e, t) {
  ...
  var d = (function () {
    function e(e) {
      if (
        ((this.options = a.mergeConfigurationOptions(e)),
    ...
    return (
      ...
      (e.prototype._createSortedPathsRules = function () {
        ...
        (this.sortedPathsRules = []),
          l.forEachProperty(this.options.paths, function (t, n) {
            l.isArray(n)
      ...
      (e.prototype._createShimModules = function () {
        ...
        (this.shimModules = {}),
          (this.shimModulesStr = {}),
          l.forEachProperty(this.options.shim, function (t, n) {
            return n
              ? l.isArray(n)
      ...
      (e.prototype._applyPaths = function (e) {
        for (var t, n = 0, o = this.sortedPathsRules.length; o > n; n++)
          if (((t = this.sortedPathsRules[n]), l.startsWith(e, t.from))) {
      ...
      (e.prototype._addUrlArgsToUrl = function (e) {
        return l.containsQueryString(e)
      ...
      (e.prototype.moduleIdToPaths = function (e) {
        ...
        var n;
        if (l.endsWith(t, ".js") || l.isAbsolutePath(t))
          l.endsWith(t, ".js") || l.containsQueryString(t) || (t += ".js"),
            (n = [t]);
        else {
          n = this._applyPaths(t);
          for (var o = 0, r = n.length; r > o; o++)
            (this.isBuild() && "empty:" === n[o]) ||
              (l.isAbsolutePath(n[o]) || (n[o] = this.options.baseUrl + n[o]),
              l.endsWith(n[o], ".js") ||
                l.containsQueryString(n[o]) ||
                (n[o] = n[o] + ".js"));
        }
      ...
      (e.prototype.requireToUrl = function (e) {
        ...
        return (
          l.isAbsolutePath(t) ||
            ...
            l.isAbsolutePath(t) || (t = this.options.baseUrl + t)),
  ...
  var h = (function () {
    ...
    return (
      ...
      (e.prototype._invokeFactory = function () {
        if (this._moduleIdResolver.isBuild() && !l.isAnonymousModule(this._id))
          ...
          if ("function" == typeof this._callback) {
            ...
            (e = t.producedError),
              ...
              e ||
                ...
                (this._exportsPassedIn && !l.isEmpty(this._exports)) ||
    ...
    return (
      ...
      (e.prototype._onLoadError = function (e, t) {
        ...
        for (s.push(e), r[e] = !0; s.length > 0; )
          if (
            ...
            for (var u = 0, l = this._inverseDependencies[n].length; l > u; u++)
      ...
      (e.prototype._onModuleComplete = function (e, t) {
        ...
        if (this._inversePluginDependencies.hasOwnProperty(e)) {
          ...
          for (
            ...
            var a = u[n].moduleId,
              d = this._modules[a];
            this._resolvePluginDependencySync(a, u[n].dependencyId, t),
              d.isComplete() && this._onModuleComplete(a, d.getExports());
          }
        }
        l.isAnonymousModule(e)
      ...
      (e.prototype._hasDependencyPath = function (e, t) {
        var n,
          ...
          u = {},
          l = [];
        for (l.push(e), u[e] = !0; l.length > 0; )
          if (((r = l.shift()), this._dependencies.hasOwnProperty(r)))
      ...
      (e.prototype._resolvePluginDependencySync = function (e, t, n) {
        var o = this,
          ...
          s = t.indexOf("!"),
          u = t.substring(0, s),
          l = t.substring(s + 1, t.length),
          a = function (e) {
            return i.resolveModule(e);
          };
        if (
          ((l = "function" == typeof n.normalize ? n.normalize(l, a) : a(l)),
          n.dynamic)
        ) {
          var d = function (n) {
            ...
            (t = l.fileUriToFilePath(t)),
              this._fs.readFile(t, { encoding: "utf8" }, function (s, u) {
                ...
                (g = /^v0\.12/.test(process.version)
                  ? i._vm.runInThisContext(c, { filename: l })
                  : i._vm.runInThisContext(c, l)),
                  g.call(I, A, C, l, i._path.dirname(t)),
    ...
    C = (function () {
      function e(e, t, n) {
        "string" != typeof e && ((n = t), (t = e), (e = null)),
          ("object" == typeof t && l.isArray(t)) || ((n = t), (t = null)),
    ...
    A = (function () {
      function e() {
        if (1 === arguments.length) {
          if (arguments[0] instanceof Object && !l.isArray(arguments[0]))
          ...
          for (e = 0; s > e; e++)
            (u = r.length - 1 - e),
              ...
              this._mergeStyleSheet(
                r[l].linkNode.href,
                this._asIE9HTMLLinkElement(r[l].linkNode).styleSheet,
                r[u].linkNode.href,
              ...
              o--;
          for (
            var a = this._styleSheetCount();
            31 > a && this._blockedLoads.length > 0;

          )
            this._insertLinkNode(this._blockedLoads.shift()), a++;
        }),
        t
      );
    })(n),
          ...
          if (
            ...
            for (
              var s = o.toUrl(n + ".css"),
                ...
                a = t.cssPluginEntryPoints[n],
                d = 0;
              d < a.length;
              d++
            )
              l.push(u.rewriteUrls(a[d].moduleName, n, a[d].contents));
            r(s, l.join("\r\n"));
          }
        }),
        (e.BUILD_MAP = {}),
          ...
          if (((a = a || {}), t && 0 !== t.length)) {
            ...
            if (s && s.getString)
              ...
              i([t + ".nls", t + ".nls.keys"], function (n, o) {
                (e.BUILD_MAP[t] = n), (e.BUILD_MAP_KEYS[t] = o), l(n);
              });
            else {
              var c = a["vs/nls"] || {},
      ...
      return (
        (e.prototype.load = function (t, n, o, r) {
          ...
          this.textLoader.load(
            ...
            function (e) {
              "function" == typeof o.error && o.error("Could not find " + a);
            }
          );
        }),
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/f291f4ad600767626b24a4b15816b04bee9a3049/vs/loader.js.map
